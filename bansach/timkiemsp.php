<?php
$tukhoa=$_GET['tukhoa']; 
$kq=$qt->TotalRecords2($tukhoa); 
$rowkq=$kq->fetch_array();
$totalRecord=$rowkq[0];
...
$kq = $qt->TimKiem($tukhoa,$start,$limit);								
                ...
                <div class="container">
                    <div class="breadcrumb-content">
                        <ul>
                            ...
                            <li class="active">Tìm kiếm <?= $tukhoa?> </li>
                        </ul>
                    </div>
                </div>
            </div>
                            ...
                            <div class="shop-top-bar mt-30">
                                <div class="shop-bar-inner">
                                    ...
                                    <div class="toolbar-amount">
                                        <span>Hiện thị <?= $totalRecord?> sản phẩm  </span>
                                    </div>
                                </div>
									  ...
									  <div class="paginatoin-area">
                                        <div class="row">
                                            <div class="col-lg-6 col-md-6">
                                                <p>Hiển thị trang <?= $start?> - <?= $limit?> sản phẩm của <?= $total_Page?> trang </p>
                                            </div>
                                            <div class="col-lg-6 col-md-6">
                                                <ul class="pagination-box">
								<?php if ($current_Page > 1 && $total_Page > 1){?>
                                                    <li><a href="index.php?p=timkiem&tukhoa=<?= $tukhoa?>&pageNum=<?=($current_Page-1)?>" class="Previous"><i class="fa fa-chevron-left"></i> Trước</a>
                                                    </li>
													<?php }?>
													...
													?>
                                                    <li ><a href="index.php?p=timkiem&tukhoa=<?= $tukhoa?>&pageNum=<?= $i?>"><?= $i?></a></li>
                                                    <?php }}?>
                                                    <li>
														<?php if ($current_Page < $total_Page && $total_Page > 1){?>
                                                      <a href="index.php?p=timkiem&tukhoa=<?= $tukhoa?>&pageNum=<?=($current_Page+1)?>" class="Next"> Tiếp <i class="fa fa-chevron-right"></i></a><?php }?>
                                                    </li>
                                                </ul>
                                            </div>
                                        </div>
