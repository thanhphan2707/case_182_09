...
if (isset($_POST['tensp'])){ 
   ...
   $soluongtonkho = $_POST['soluongtonkho'];
	...
	$ngay=$_POST['ngay'];
	$idLSP=$_POST['idLSP'];
   $qt->SP_Them($idTLSP,$idLSP, $tensp,$mota,$ngay,$gia,$UrlHinh,$soluongtonkho,$saleoff); 
                    ...
                    <div class="card">
                        ...
                        <div class="body">
                            <form id="form_validation" method="POST">
                                <div class="form-group form-float">
                                    <div class="form-line">
                                        <input type="text" class="form-control" name="tensp" required maxlength="100" minlength="10"  placeholder="Nhập tên sp"> 
								...
								<div class="form-group form-float">
									...
									<div class="form-line">
                                        <input type="text" class="form-control" name="soluongtonkho" placeholder="Số lượng hàng" required>
                                        
                                    </div>
                                </div>
								<div class="form-group form-float">
                                    <div class="form-line">
                                        <input type="text" class="form-control" name="saleoff" placeholder="Giảm giá" required>
								...
								<div class="form-group form-float "> 
									<div class="form-line">
										<input type="text" name="hinhanh" id="hinhanh" class="form-control" onclick="selectFileWithCKFinder('hinhanh')" placeholder="Địa chỉ hình của sản phẩm">
									</div> 
								</div>
								...
								<div class="row cleafix">
								  <div class="col-md-6">
									 <div class="form-group form-float">
									 <div class="form-line">
									 <input  type="text" class=" datepicker form-control" name="ngay" placeholder="Ngày cập nhật">
									 </div>
									 </div>
								  </div>
								</div>
						...
						<option value="<?= $rowkq['idLSP']?>"><?= $rowkq['Ten']?></option>
							<?php }?>
								...
								<div class="form-group form-float">
                                    <div class="form-line">
                                        <textarea name="mota" cols="30" rows="5" class="form-control no-resize" placeholder="Nội dung mô tả sản phẩm"></textarea>
